...
Contoh pemakaian:
  ...
  python window_burst9er.py data.md 10 10 --format raw

  python window_burst9er.py data.md 10 20 --format raw

  python window_burst9er.py data.md 10 2000 --format raw

  python window_burst9er.py data.md 10 2000 --format all
